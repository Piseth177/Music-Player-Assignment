...
public class Artist implements Displayable {
    ...
    // Adds a song to this artist's song list if it is not null and not already present.
    ...
    // Adds an album to this artist's album list if it is not null and not already present.
